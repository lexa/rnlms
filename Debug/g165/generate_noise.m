...
y=awgn(x,8.14,'measured',1506);
filtered_noise_0=filter(filter_coefs, 1,y-x);
echo_0_128=filter(echo_path_128, 1, filtered_noise_0);
echo_0_256=filter(echo_path_256, 1, filtered_noise_0);
echo_0_512=filter(echo_path_512, 1, filtered_noise_0);
echo_0_1024=filter(echo_path_1024, 1, filtered_noise_0);
...
fid_far_0=fopen('filtered_noise_0.dat','w');
...
fid_echo_0_128=fopen('echo_0_128.dat','w');
...
fid_echo_0_256=fopen('echo_0_256.dat','w');
...
fid_echo_0_512=fopen('echo_0_512.dat','w');
...
fid_echo_0_1024=fopen('echo_0_1024.dat','w');
...
fwrite(fid_far_0, filtered_noise_10, 'int16');
...
fwrite(fid_echo_0_128, echo_0_128, 'int16');
...
fwrite(fid_echo_0_256, echo_0_256, 'int16');
...
fwrite(fid_echo_0_512, echo_0_512, 'int16');
...
fwrite(fid_echo_0_1024, echo_0_1024, 'int16');
...
fid10=fopen('filtered_noise_0.dat','r');
fid20=fopen('echo_0_512.dat','r');
...
[H,F]=freqz(filter_coefs,1,512,8000);
